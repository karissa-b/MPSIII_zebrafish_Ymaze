...
meta <-
  read_excel("data/metadata/hgsnat 3-month behavioural metadata.xlsx") %>%
  mutate(
...
final_data <- read_csv("data/processed_data/hgsnat/3m/final_output.csv") %>%
  dplyr::select(-1) %>%
